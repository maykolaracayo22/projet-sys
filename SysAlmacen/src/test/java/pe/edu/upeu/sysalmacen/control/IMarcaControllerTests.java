...
public class IMarcaControllerTests {
    @Mock
    ...
    private static final Logger logger = Logger.getLogger(IMarcaControllerTests.class.getName());
    List<Marca> marcas;
    ...
    void testSave_ReturnsCreatedStatusAndLocationHeader() {
        ...
        ResponseEntity<CustomResponse> response = marcaController.save(marcaDTO);
    ...
    void testDelete_ReturnsCustomResponse_WithHttpStatusOK() {
        Long id = 1L;
        CustomResponse customResponse = new CustomResponse(200, LocalDateTime.now(),
                "true", "Todo Ok");
