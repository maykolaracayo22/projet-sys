        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/maykolaracayo22/projet-sys.git'
                }
            }
        }
        stage('Build') {
